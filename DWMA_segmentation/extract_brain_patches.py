...
def get_data_training(train_imgs,
    ...
    train_imgs = train_imgs      #   45*80  1, 195,  156
    train_masks = train_groudTruth         #masks always the same
    train_bordermasks = train_bordermasks   #bordermasks always the same
    print ("\ntrain images/masks shape:")
    print(train_imgs.shape)
    
    N_subimgs = N_subimgs_per_img*train_imgs.shape[0]

    #extract the TRAINING patches from the full images

    patches_imgs_train, patches_masks_train = extract_random(train_imgs,train_masks,patch_height,
...
def get_data_testing_overlap(test_imgs,
                             test_groudTruth, 
                             patch_height, patch_width, 
                             stride_height, stride_width):
    ### test
    test_imgs = test_imgs
    test_masks = test_groudTruth
...
def extract_random(full_imgs,full_masks, patch_h, patch_w, N_patches, inside=True):
    if (N_patches%full_imgs.shape[0] != 0):
        ...
        print (full_imgs.shape[0])
        print ("N_patches must be a multiple of full image sample size")
        exit()
...
#                    continue
            ...
            iter_tot +=1   #total
            k+=1  #per full_img
#            print ("Total patches: " +str(iter_tot))
...
def is_patch_inside_FOV(x,y,img_w,img_h,patch_h):
    ...
    R_inside = 100 - int(patch_h * np.sqrt(2.0) / 2.0) #radius is 0.5*max axis minus the patch diagonal (assumed it is a square #this is the limit to contain the full patch in the FOV
